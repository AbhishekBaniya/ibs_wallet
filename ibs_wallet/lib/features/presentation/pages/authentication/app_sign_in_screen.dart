...
import 'package:ibs_wallet/features/presentation/widgets/extension_sizedbox_widget.dart';

import '../../controller/auth/app_auth_controller.dart';

class AppSignInScreen extends StatelessWidget {
  final userNameController, userMobileNumberController, userEmailIdController, userPasswordController, confirmPasswordController;
  const AppSignInScreen({super.key, required this.userNameController, required this.userMobileNumberController, required this.userEmailIdController, required this.userPasswordController, required this.confirmPasswordController,});
